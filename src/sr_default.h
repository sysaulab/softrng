...
T: Type of command, this tell you about the role of the command.\n\
    ...
    f: Filters, manipulation of the stream\n\
...
\n\
s-icm64 | f-hex\n\
    Display the strem generated by input converted in hexadecimal format.\n\
\n\
s-zeros | f-hex\n\
...
\n\
g-icm64 | f-bench | g-roxo64 | f-void\n\
...
\n\
g-icm64 | f-output seed.bin | g-roxo64 | f-output rand.bin | f-void\n\
